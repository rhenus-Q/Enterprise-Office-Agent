...
As of Phase 6 (Office Agent v1.5) six capabilities are supported — `knowledge_qa`
...
(the local mock Task / Ticket Assistant), `daily_briefing` (the local mock Daily
Briefing aggregator), and `meeting_agent` (the local mock Meeting Agent / Meeting
Prep). Any other request routes to `unknown` and returns a clear
