...
As of Phase 4 five intents exist (`knowledge_qa`, `email_summary`,
`calendar_lookup`, `ticket_assistant`, `unknown`); the daily-briefing intent is
deliberately NOT defined until its own phase lands.
"""
