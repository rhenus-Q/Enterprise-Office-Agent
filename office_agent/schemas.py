...
As of Phase 3 four intents exist (`knowledge_qa`, `email_summary`,
`calendar_lookup`, `unknown`); ticket / task / briefing intents are deliberately
NOT defined until their own phases land.
"""
