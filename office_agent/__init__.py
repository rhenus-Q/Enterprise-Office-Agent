"""
office_agent — the Enterprise Office Agent (Phase 5 / v1).
...
Implemented capabilities (Office Agent v1):
...
Everything is local, mock, deterministic, and LLM-free. Anything added here must
