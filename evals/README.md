...
uv run python evals/run_eval.py --no-answer-text
...
`evals/results.md` is generated from whatever dataset you run. **By default it
...
- `evals/history/*.json` records are **always metadata-only** regardless of this
