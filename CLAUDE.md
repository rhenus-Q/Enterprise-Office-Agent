...
| `docs/adr/` | Architecture Decision Records (001–016) with an index in `docs/adr/README.md`. When a documented decision changes, update or supersede the matching ADR. |
