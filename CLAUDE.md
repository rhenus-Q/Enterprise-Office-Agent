...
| `docs/adr/` | Architecture Decision Records (001–019) with an index in `docs/adr/README.md`, split by owning package: `docs/adr/enterprise_rag/` (001–014, plus [019 — hierarchical runtime privacy modes](docs/adr/enterprise_rag/019-hierarchical-runtime-privacy-modes.md)) and `docs/adr/office_agent/` (015–018). When a documented decision changes, update or supersede the matching ADR. |
